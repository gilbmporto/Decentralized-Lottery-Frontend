    ...
    <div>
      {raffleAddress ? (
        <div className="flex flex-col justify-center align-middle content-center items-center mt-3 mx-2">
          ...
          <p className="my-2">3) Exactly after 2 days, if there is at least one address entered in the raffle contract and if there is at least 0,1 ETH inside, the raffle happens.</p>
          ...
          <p className="my-2">Total prize in USD: <span className="text-lg font-bold text-green-500">{(ethPriceInUsd * numPlayers).toFixed(2)} USD</span></p>
        </div>
      ) : (
        <div className="flex flex-col justify-center align-middle content-center items-center mt-3 mx-2">
          <p className="my-2">Welcome to a truly decentralized and fraud-proof lottery!</p>
          ...
          <p className="my-2"><b>One address will always win</b> and, then, the lottery is reseted.</p>
          <p className="my-2 text-lg text-red-400"><b>You must connect your wallet and connect into goerli network to enter the raffle!</b></p>
          </div>
      )}
